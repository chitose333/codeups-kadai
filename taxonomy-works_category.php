...
<div class="p-sub-main p-works-mainview">
  ...
  <div class="l-inner">
    ...
    <a class="c-category__btn is-active" href="<?php echo esc_url( get_post_type_archive_link( 'works' ) ); ?>">ALL</a>
      <?php
        $genre_terms = get_terms( 'works_category', array( 'hide_empty' => false ) );
