    ...
    <div class="p-contact__container l-inner">
      ...
      <div class="p-contact__footer">
        <div class="c-util-link__container">
          <a class="c-util-link c-util-link--contact" href="#">お問い合わせへ</a>
        </div>
      </div>
    ...
    <div class="p-footer__container">
      ...
      <nav class="p-footer__menu">
        <ul class="p-footer__menu__items">
          <li class="p-footer__menu__item"><a href="#">トップ</a></li>
          <li class="p-footer__menu__item"><a href="#">お知らせ</a></li>
          <li class="p-footer__menu__item"><a href="#">事業内容</a></li>
          <li class="p-footer__menu__item"><a href="#">企業概要</a></li>
          <li class="p-footer__menu__item"><a href="#">ブログ</a></li>
          <li class="p-footer__menu__item p-footer__menu__item--p-top-contact"><a href="#">お問い合わせ</a></li>
        </ul>
      </nav>
